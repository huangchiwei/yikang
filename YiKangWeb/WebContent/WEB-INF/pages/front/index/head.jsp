...
<div class="w_top"><div class="fl_top">欢迎登录广东省健康产业公共服务平台！</div>
  ...
  <div class="nav">
    <ul class="nav_list">
      ...
      <li class="drop-menu-effect"><a href="${ctx}/front/train/list/?cateCode=lecture"><span>健康培训</span></a>
      <ul class="submenu">
          <li><a href="${ctx}/front/train/list/1.html?cateCode=lecture">健康大讲堂</a></li>
