 ...
 <div class="reg_b">
  ...
  <form id="loginForm" action="${ctx}/front/account/saveRegister.html" method="post" onsubmit="return checkForm()">
    <ul class="ul">
     ...
     <li class="li"><span class="span"><font class=" c_ff0000">*</font>&nbsp;&nbsp;常用邮箱：</span><input name="email" type="password" id="email" class="input" size="37" value="${account.email }"/><em>请输入常用邮箱地址！</em>
     </li>
