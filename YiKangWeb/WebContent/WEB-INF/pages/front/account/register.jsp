  ...
  <form id="loginForm" action="${ctx}/front/account/saveRegister.html" method="post" onsubmit="return checkForm()">
    <ul class="ul">
     <li class="li"><span class="span"><font class=" c_ff0000">*</font>&nbsp;&nbsp;用户名：</span>
       <input name="accountNo" id="accountNo" type="text" class="input" size="37"  /><em>4~16个字符，字母/数字</em>
     </li>
     <li class="li"><span class="span"><font class=" c_ff0000">*</font>&nbsp;&nbsp;密　码：</span><input name="pwd" id="pwd" type="password" class="input" size="37" /><em>请设置密码</em>
     </li>
     ...
     <li class="li"><span class="span"><font class=" c_ff0000">*</font>&nbsp;&nbsp;常用邮箱：</span><input name="email" type="text" id="email" class="input" size="37" /><em>请输入常用邮箱地址！</em>
     </li>
