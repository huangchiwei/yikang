...
<div class="login_box">
 <div class="login_t">
  <div class="logo"><div class="fl"><a href="#"><img src="images/logo_login.png" width="112" height="50" /></a></div><h1>找回密码</h1></div>
  ...
  <div class="forget_a">
   ...
   <span><div class="a2">第三步：完成</div></span>
    ...
    <ul class="ul">
     ...
     <li class="li"><span class="span">邮箱地址：</span><input type="password" class="input" size="30" />
     <em>请输入注册的邮箱</em>
     </li>
     <li class="li"><span class="span">验证码：</span><input type="text" class="input" size="8" />
     <em><img src="images/yzm.png" width="80" height="30" /></em><label>看不清？<a href="#">换一张</a></label>
     </li>
     <li class="li"><div class="btn_box"><input type="button" class="login" value="下一步" /></div></li>
    </ul>
 </div>
 <!--bot-->
  <div class="bot">
