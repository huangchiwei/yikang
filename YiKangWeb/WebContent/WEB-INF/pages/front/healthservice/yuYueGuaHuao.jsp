 ...
 <div class="news_nav">
  <div class="n_box">
   ...
   <div class="lanren">
    ...
    <a href='javascript:' class="thisclass">预约挂号</a>
   </div>
  </div>
  <div class="search">
 ...
 <!--二级头部_end-->
  ...
  <div class="s_brumbs">
	...
	预约挂号</div>
    	...
    	<iframe id="mainIframe" onload="resetHeight()" allowtransparency="true" height="1800px" name="mainIframe" frameborder="0" width="100%"  src="http://yyk.39.net/"></iframe>
