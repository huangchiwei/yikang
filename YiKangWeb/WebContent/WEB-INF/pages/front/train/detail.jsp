...
<div class="news_top">
 <div class="index_nav">
  <div class="logo"><img src="${ctx}/js/front/train/images/logo.png" /></div>
...
<div class="news_nav">
  <div class="n_box">
   ...
   <div class="lanren">
    ...
    <a href="${ctx}/front/train/list/1.html?cateCode=lecture" <c:if test="${cateCode=='lecture'}">class="thisclass"</c:if>>健康大讲堂</a>
