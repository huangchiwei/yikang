...
<div class="n">
 ...
 <!--二级头部_end-->
  ...
  <div class="s_brumbs">当前位置：<a href="${ctx}">首页</a>&nbsp;&gt;&nbsp;<a href="${ctx}/healthDatabase/ypk/1.html">药品库</a>&nbsp;&gt;&nbsp;${entity.Name}（${entity.NormalName}）</div>
   <div class="d">
    <div class="subLogo"><h1>${entity.Name}</h1><div class="name">（${entity.NormalName}）</div>
    </div>
     ...
     <div class="clearfix">
      ...
      <div class="doctor_box">
       <div class="js relative">
         <dl class="dl"><dt>药品名称：</dt><dd>${entity.Name}（${entity.NormalName}）</dd></dl>
       ...
       <div class="module3">
          <div class="titleBar"><h2>${entity.Name}（${entity.NormalName}）的药品说明书</h2></div>
      ...
      <div class="sideBar">
       <div class="module2"><div class="titleBar"><h4><a href="#">其他药品</a></h4></div> 
        <div class="moduleContent2">
         ...
         <div class="imgText_img"><a href="#"><img src="${ctx}/theme/front/healthdatabase/images/201308010224145850.jpg" width="60" height="60" /></a></div>
         <div class="text">
          <h4><a href="#">六味地黄丸</a></h4>
          <div class="sc">滋阴补肾。用于肾阴亏损，头晕耳鸣…<a href="#" class="actionA">[详细]</a></div>
          </div></div>
          <div class="imgText_60_75">
         <div class="imgText_img"><a href="#"><img src="${ctx}/theme/front/healthdatabase/images/201308010224145850.jpg" width="60" height="60" /></a></div>
         <div class="text">
