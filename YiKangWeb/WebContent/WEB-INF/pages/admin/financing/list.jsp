...
<script type="text/javascript">
	function delConfirm(id){
		$.layer({
		  ...
		  dialog : {
		      ...
		      btn : ['是','否'],
		      yes : function(){
		          location.href='${ctx}/admin/financing/delete.html?id=' + id;
		      },
		      no : function(index){
		         layer.close(index);
		      }
	...
	function verify(id,status){
		location.href = "${ctx}/admin/financing/verify.html?id=" + id + "&status=" + status;
	}
</script>
</head>
...
<tr>
      ...
      <c:forEach items="${list}" var="o">
        ...
        <td>${o.isTop == 1 ? '是' : '否'}</td>
        <td><img style="cursor: pointer;" src="${ctx}/theme/admin/default/images/file_icon.png" onclick="javascript:location.href='${ctx}/admin/financing/update/${o.id}.html'"/>&nbsp;
           <img style="cursor: pointer;" src="${ctx}/theme/admin/default/images/edit_icon.png" onclick="javascript:location.href='${ctx}/admin/financing/update/${o.id}.html'"/>&nbsp;
          <img style="cursor: pointer;" src="${ctx}/theme/admin/default/images/del_icon.png" onclick="delConfirm(${o.id})"/>
          <c:choose>
        		<c:when test="${o.isTop == 1}"><a style="color: red" href="#" onclick="javascript:location.href='${ctx}/admin/financing/isTop.html?id=${o.id}&isTop=0'">&nbsp;&nbsp;取消置顶</a></c:when>
        		<c:when test="${o.isTop == 0}"><a style="color: red" href="#" onclick="javascript:location.href='${ctx}/admin/financing/isTop.html?id=${o.id}&isTop=1'">&nbsp;&nbsp;置顶</a></c:when>
        	</c:choose>
