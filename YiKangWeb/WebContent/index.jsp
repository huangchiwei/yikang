...
<div class="w_990">
  ...
  <div class="nav">
    <ul class="nav_list">
      ...
      <li class="drop-menu-effect"><a href="#"><span>行业资讯</span></a>
        <ul class="submenu">
          <li><a href="show_dig.html">法律法规</a></li>
          <li><a href="show_dig.html">行业新闻</a></li>
          <li><a href="show_dig.html">行业焦点</a></li>
          <li><a href="show_dig.html">重要活动</a></li>
        </ul>
      </li>
      <li class="drop-menu-effect"><a href="#"><span>行业活动</span></a></li>
      <li class="drop-menu-effect"><a href="#"><span>健康服务</span></a>
      <ul class="submenu">
          <li><a href="show_dig.html">症状查询</a></li>
          <li><a href="show_dig.html">医生查询</a></li>
          <li><a href="show_dig.html">疾病查询</a></li>
          <li><a href="show_dig.html">专家查询</a></li>
          <li><a href="show_dig.html">就医指南</a></li>
          <li><a href="show_dig.html">预约挂号</a></li>
        </ul>
      </li>
      <li class="drop-menu-effect"><a href="#"><span>健康购</span></a></li>
      <li class="drop-menu-effect"><a href="#"><span>健康数据库</span></a>
      <ul class="submenu">
          <li><a href="plan_spreed.html">医院库</a></li>
          <li><a href="plan_list.html">专家库</a></li>
          <li><a href="plan_list.html">药品库</a></li>
          <li><a href="plan_list.html">保健品库</a></li>
        </ul>
      </li>
      <li class="drop-menu-effect"><a href="#"><span>健康培训</span></a>
      <ul class="submenu">
          <li><a href="plan_spreed.html">健康大讲堂</a></li>
          <li><a href="plan_list.html">资质培训</a></li>
          <li><a href="plan_list.html">技能培训</a></li>
        </ul>
        </li>
      <li class="drop-menu-effect"><a href="#"><span>投融资服务</span></a>
      <ul class="submenu">
          <li><a href="plan_spreed.html">项目库</a></li>
          <li><a href="plan_list.html">资金库</a></li>
          <li><a href="plan_list.html">行业专家</a></li>
          <li><a href="plan_list.html">行业机构</a></li>
        </ul>
      </li>
    </ul>
  </div>
