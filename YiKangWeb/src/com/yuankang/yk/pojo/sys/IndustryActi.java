 ...
 */
@Entity
@Table(name = "industry_acti", catalog = "yikang")
public class IndustryActi implements java.io.Serializable {
	...
	/** full constructor */
	public IndustryActi( String title, String content, String digest,
